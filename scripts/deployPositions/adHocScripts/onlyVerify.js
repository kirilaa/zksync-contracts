...
async function main() {
	...
	await hre.run('verify:verify', {
		address: '0xe1f160E7d40738BF6eDb830360B9Efbbe966765c', //PositionalMarketFactoryDeployed.address,
		constructorArguments: [owner.address],
	});

	await hre.run('verify:verify', {
		address: '0xc44DfC6ffaf195E2535fc13D75a79D9238459782', //PositionMastercopyDeployed.address,
	...
	await hre.run('verify:verify', {
		address: '0x99D3cF3A00Dcb3DfeDAd5eb89257792c8c897306', //PositionalMarketData.address,
		constructorArguments: [],
	});

	await hre.run('verify:verify', {
		address: '0x40cD00000cE1e8B6F6FBfA896C05A0c701d37E09', //PositionalMarketManagerDeployed.address,
		constructorArguments: [
			owner.address,
