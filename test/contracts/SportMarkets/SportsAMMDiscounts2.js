...
contract('SportsAMM', (accounts) => {
	...
	describe('Test SportsAMM', () => {
		...
		it('Buy from SportsAMM, position 1, value: 100', async () => {
			...
			console.log('buyPriceImpactFirst 1: ', fromUnit(buyPriceImpactFirst));

			buyPriceImpactFirst = await SportsAMM.buyPriceImpact(
				deployedMarket.address,
				0,
				toUnit(30000)
			);
			console.log('buyPriceImpactFirst 30000: ', fromUnit(buyPriceImpactFirst));
			...
			console.log('buyPriceImpactFirst 71190: ', fromUnit(buyPriceImpactFirst));
			...
			console.log('buyPriceImpactFirst 72001: ', fromUnit(buyPriceImpactFirst));
		});
	});
});
